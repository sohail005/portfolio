    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <motion.span className="circle circle1" animate={{ scale: [0.9, 1.05, 0.95, 1] }} transition={{ repeat: Infinity, duration: 3 }} />
                    <motion.span className="circle circle2" animate={{ scale: [1, 0.95, 1.05, 1] }} transition={{ repeat: Infinity, duration: 3.2 }} />
                    <motion.span className="circle circle3" animate={{ scale: [1, 1.05, 0.95, 1] }} transition={{ repeat: Infinity, duration: 3.5 }} />
                    <motion.span
                ...
                >
                    ...
                    >
                        I'm probably the most passionate developer & designer you will ever get to work with. If you have a great project that needs some amazing Tech Skills, I'm your guy.
                    </motion.span>
                </motion.div>
                ...
                >
                    ...
                    >
                        {svgdata.map((path, i) => (
                            <motion.a
                                key={i}
                                className={`social-button social-button${i + 1}`}
                                href={[
                                    'https://www.instagram.com/sohail.code?igsh=cjRrdGZoYnBobTBl',
                                    'https://x.com/SohailP53076688?t=2c_RHFvxAH1-Smz0FsGvww&s=09',
                                    'https://discord.gg/nnw484GY',
                                    'https://shorturl.at/wCJQ1',
                                    'https://github.com/sohail005'
                                ][i]}
                                target="_blank"
                            ...
                            >
                                {i != 0 ?
                                    <svg width="26" height="24" viewBox="0 0 512 512" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                        <path d={path} />
                                    </svg>
                                    :
